...
/// in [`pool_set_canon.h`](../oracle_guided_search/pool_set_canon.h), which answers it from generators.
...
/// coset. [`pool_set_canon.h`](../oracle_guided_search/pool_set_canon.h) answers both questions by
...
/// [`deduplication-cost.md`](../oracle_guided_search/deduplication-cost.md) carries the before and after,
