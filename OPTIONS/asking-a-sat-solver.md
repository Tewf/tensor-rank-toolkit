...
([`../satisfiability/search.md`](../satisfiability/search.md)), and it **lost**
...
**That table wants re-running before it is quoted again**, and `search.md` says
