...
#
# There is no CUDA in this image and none is wanted. infrastructure/gpu_leaf/ is built only
...
# infrastructure/gpu_leaf/what-the-card-did.md were taken on. Those are reproduced by the
