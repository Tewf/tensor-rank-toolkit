...
def claims():
    ...
    return [(
        ...
        ["index.html",
         ...
         "README.fr.md",
         "what-it-computes.md",
         "writeup/how-the-search-works/README.md",
         "OPTIONS/committing-to-candidates.md",
         "methods/canonical_factorisation/canonical-augmentation.md",
        ...
        ["index.html",
         "README.md",
         "what-it-computes.md",
         "writeup/how-the-search-works/what-to-wire.md",
        ...
        ["README.md", "what-it-computes.md", "writeup/article/bilinear-rank.tex"],
    ), (
        "the same, in French",
        ...
        f"& {as_given} & {minimum} &",
        ["writeup/article/bilinear-rank.tex"],
    )]
