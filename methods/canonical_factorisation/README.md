...
```sh
factor-over-canonical-basis evidence/fixtures/gf4_multiplication.tensor
```
...
For two slices, `methods/pencil_rank/` answers a related question in polynomial time
