...
///
///     build/methods/bilinear_rank/exhaustive_search/decide-rank FIXTURE --target K [--node-limit N]
///     build/methods/bilinear_rank/exhaustive_search/decide-rank FIXTURE --target K [--node-limit N] --general-leaf
///
