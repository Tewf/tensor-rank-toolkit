...
/// in [`pool_set_canon.h`](../canonical_augmentation/pool_set_canon.h), which answers it from generators.
...
/// coset. [`pool_set_canon.h`](../canonical_augmentation/pool_set_canon.h) answers both questions by
...
/// [`deduplication-cost.md`](../canonical_augmentation/deduplication-cost.md) carries the before and after,
