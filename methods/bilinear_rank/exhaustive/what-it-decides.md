...
[`../greedy_heuristic/`](../greedy_heuristic/); the guarantees
...
| F2 5×5 | **exactly 13**, both sides here | 9 to 11 ruled out by the polynomial floor before a node opens; 12 ruled out exhaustively here; 13 exhibited by [`tighten-rank-bound`](../branch_and_bound/) in 80 nodes. `[bdez2012]` report the same 13 |
