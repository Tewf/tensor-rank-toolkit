#!/bin/sh
# That the commands read a command line the way `infrastructure/cli/arguments.h` says they do.
#
...
refuses 2 "unrecognised option: --bogus" "$binaries/infrastructure/run_limits/show-limits" --bogus
