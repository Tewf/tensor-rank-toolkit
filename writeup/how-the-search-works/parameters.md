...
The signatures the [pseudocode](./) stands for, with the meaning of each
...
Anchored at the map, a run from scratch costs `C(|pool|, k − dim T)` nodes,
which is what every measured question in [`README.md`](README.md) runs.
