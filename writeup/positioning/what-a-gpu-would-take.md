...
[`../../infrastructure/gpu_leaf/README.md`](../../infrastructure/gpu_leaf/README.md), on the RTX 4060 Laptop this page
...
([`../../infrastructure/gpu_leaf/what-the-card-did.md`](../../infrastructure/gpu_leaf/what-the-card-did.md)), so the
...
- **Nothing needs transferring.** `at(i)` is a pure function of `i`, so a thread
  ...
  **under 300 KB against 8 GB.** The 8.2 TiB never exists anywhere.
  [`../../methods/bilinear_rank/orbit_reduction/pool_orbits.h`](../../methods/bilinear_rank/orbit_reduction/pool_orbits.h)'s
...
[`../../infrastructure/gpu_leaf/README.md`](../../infrastructure/gpu_leaf/README.md) now prices the same
